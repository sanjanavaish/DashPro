...
const Leave: React.FC = () => {
  ...
  const handleStatusUpdate = (requestId: string, status: 'approved' | 'rejected', comments?: string) => {
                ...
                <tbody>
                  {filteredRequests.map((request) => (
                    <tr key={request.id} className="border-b hover:bg-gray-50">
                      ...
                      <td className="p-2 text-xs sm:text-sm max-w-xs truncate hidden lg:table-cell" title={request.reason}>
                        {request.reason}
                      </td>
